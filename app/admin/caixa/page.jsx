    ...
    <div style={{ padding: "1rem" }}>
      ...
      <section className={`${styles.resumoContainer} mb-4`}>
        ...
        <div
          ...
          style={{
            backgroundColor: "var(--primaria-clara)",
          }}
        >
      ...
      {/* ── Filtros de Período ── */}
      <section
        className={`${styles.cardFiltros} mb-4 d-flex gap-3 align-items-end`}
      >
        <div style={{ flex: 1 }}>
          ...
          <div className={`${styles.cardTabela} d-none d-md-block`}>
            <table className="table mb-0">
              ...
              <tbody>
                {movimentacoes.map((m) => (
                  <tr key={m.id}>
                    <td className={`p-3 ${styles.tdHora}`}>
              ...
              <div className="modal-body d-flex flex-column gap-3">
                ...
                <div>
                  ...
                  <input
                    type="text"
                    className={`form-control ${styles.inputFiltro}`}
                    placeholder="Ex: Pagamento serviço X"
