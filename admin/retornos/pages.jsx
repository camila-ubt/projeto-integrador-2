    ...
    <div style={{ padding: "1rem" }}>
      ...
      <section className={`${styles.cardFiltros} mb-4 row g-3`}>
        <div className="col-12 col-sm-5">
          <label className={styles.labelFiltro}>Data Início</label>
          <input 
            type="date" 
        ...
        <div className="d-flex flex-column gap-2">
          {retornos.map((retorno) => (
            <div key={retorno.id} className={styles.cardMobile}>
              <div className={styles.cardHoraDestaque}>
                {retorno.horario}
              </div>
              <div className={styles.cardCentro}>
                ...
                <p className={styles.cardData}>{formatarDataCurta(retorno.data)}</p>
              </div>
